...
void loop() {
    if(Serial.available()){
        ...
        if (inputString == "ALIGN"){
          ...
          Serial.println("DPC0");
          digitalWrite(EPI_LED, LOW);
          matrix.fillRect(0, 0, 32, 16-NB_BLACK, matrix.Color333(7, 0, 0));
          ...
          matrix.fillRect(0, 16+NB_BLACK, 32, 16-NB_BLACK, matrix.Color333(7, 0, 0));
        }
        else if (inputString == "DPC2"){
          Serial.println("DPC2");
          digitalWrite(EPI_LED, LOW);
          matrix.fillRect(0, 0, 16-NB_BLACK, 32, matrix.Color333(7, 0, 0));
          ...
          matrix.fillRect(16+NB_BLACK, 0, 16-NB_BLACK, 32, matrix.Color333(7, 0, 0));
        }
