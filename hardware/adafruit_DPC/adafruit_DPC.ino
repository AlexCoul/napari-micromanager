...
void loop() {
    if(Serial.available()){
        ...
        if (inputString == "ALIGN"){
          ...
          matrix.fillRect(0, 16, 32, 16, matrix.Color333(7, 0, 0));
        }
        else if (inputString == "DPC2"){
          Serial.println("DPC2");
          digitalWrite(EPI_LED, LOW);
          matrix.fillRect(0, 0, 16, 32, matrix.Color333(7, 0, 0));
          matrix.fillRect(16, 0, 16, 32, matrix.Color333(0, 0, 0));
        }
        else if (inputString == "DPC3"){
          Serial.println("DPC3");
          digitalWrite(EPI_LED, LOW);
          matrix.fillRect(0, 0, 16, 32, matrix.Color333(0, 0, 0));
          matrix.fillRect(16, 0, 16, 32, matrix.Color333(7, 0, 0));
        }
